...
if __name__ == "__main__":
    ...
    # For one of the compounds, tamoxifen, the synonyms included a SMILES string which was unable to
    # retrieve data from ChEMBL SPARQL endpoint. This was manually overwritten and the code directly
    # inputted to the SPARQL endpoint provided in the web. This way the SMILES string didn't give an
    # error.
